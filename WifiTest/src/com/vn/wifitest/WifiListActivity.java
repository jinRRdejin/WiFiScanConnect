			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				alert.setPositiveButton("连接", new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which) {
						String pw = et_password.getText().toString();	//拿到输入的密码	
	...
	public class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(scanResult.capabilities.contains("WEP")||scanResult.capabilities.contains("PSK")||
				...
				switch (level) {
				case 0:
					wifi_level.setImageResource(R.drawable.ic_wifi_lock_signal_0);
					break;
				case 1:
					wifi_level.setImageResource(R.drawable.ic_wifi_lock_signal_1);
					break;
				case 2:
					wifi_level.setImageResource(R.drawable.ic_wifi_lock_signal_2);
					break;
				case 3:
					wifi_level.setImageResource(R.drawable.ic_wifi_lock_signal_3);
					break;
				case 4:
					wifi_level.setImageResource(R.drawable.ic_wifi_lock_signal_4);
					break;
...
//				wifi_level.setImageResource(R.drawable.ic_wifi_lock_signal_0);
				...
				switch (level) {
				case 0:
					wifi_level.setImageResource(R.drawable.ic_wifi_signal_0);
					break;
				case 1:
					wifi_level.setImageResource(R.drawable.ic_wifi_signal_1);
					break;
				case 2:
					wifi_level.setImageResource(R.drawable.ic_wifi_signal_2);
					break;
				case 3:
					wifi_level.setImageResource(R.drawable.ic_wifi_signal_3);
					break;
				case 4:
					wifi_level.setImageResource(R.drawable.ic_wifi_signal_4);
					break;
	    ...
	    public void onReceive(Context context, Intent intent) {   
	        ...
	        if(wifiInfo.isConnected()){
	        	...
	        	String wifiSSID = wifiManager.getConnectionInfo()
						.getSSID();
	        	Toast.makeText(context, wifiSSID+ "连接成功啦啦啦啦啦啦", 1).show();
